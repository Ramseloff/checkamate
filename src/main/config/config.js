export const field = [
    ...
    { x: 3, y: 5, name: 'e6', piece: {type: 'queen', color: 'black', name: 'blackQueen', img: 'blackQueen.svg'} }, { x: 3, y: 6, name: 'f6', piece: {} },
    ...
    { x: 5, y: 5, name: 'e4', piece: {type: 'queen', color: 'white', name: 'whiteQueen', img: 'whiteQueen.svg'} }, { x: 5, y: 6, name: 'f4', piece: {} },
    ...
    { x: 6, y: 5, name: 'e3', piece: { type: 'king', color: 'white', name: 'whiteKing', img: 'whiteKing.svg' } }, { x: 6, y: 6, name: 'f3', piece: {} },
